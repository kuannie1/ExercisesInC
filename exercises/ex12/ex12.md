...
If overhead means some sort of "cost", I think synchronization has a time cost, around 10 seconds. 
This is the result I got for counter:
'''
    real    0m4.693s
    user    0m8.712s
    sys     0m0.052s
'''
This is the result I got for counter_mutex (with synchronization):
'''
    real    0m15.965s
    user    0m12.016s
    sys     0m16.288s
